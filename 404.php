...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar d-flex flex-column align-items-center">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="login/login.php" class="nav-item nav-link"><i class="fa fa-sign-in-alt me-2"></i>Connexion</a>
            <?php if (isAdmin()) : ?>
            ...
            <a href="#" id="logout-button" class="nav-item nav-link"><i class="fa fa-sign-out-alt me-2"></i>Logout</a>
        </div>
    </nav>
</div>
<!-- Sidebar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center p-4">
                        ...
                        <p class="mb-4">Désolé, vous n'avez pas l'autorisation d'accéder à cette page. Veuillez contacter l'administrateur du site si vous pensez qu'il s'agit d'une erreur ou si vous avez besoin d'accéder à cette page pour une raison légitime. Merci de votre compréhension.</p>
