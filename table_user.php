        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    <?php
                    $query = "
                    SELECT p.*, GROUP_CONCAT(d.nom SEPARATOR ', ') AS developpeurs 
                    FROM Projets p
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>";
                            echo "<th scope='row'>" . $row['id_projet'] . "</th>";
                            echo "<td>" . $row['nom'] . "</td>";
                            
                            echo "<td><a href='show_project.php?id=" . $row['id_projet'] . "' class='btn btn-primary'>Show</a></td>";
