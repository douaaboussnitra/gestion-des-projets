...
if(isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM Documentation WHERE id_projet='$id_projet'";
    $result = mysqli_query($conn, $query);
    
    if(mysqli_num_rows($result) > 0) {
        $row = mysqli_fetch_assoc($result);
        $proc_ins_local = $row['proc_ins_local'];
        $proc_ins_production = $row['proc_ins_production'];
...
<!-- Sidebar End -->
        ...
        <div class="row justify">
            <div class="col-md-8">
                <h2>Project ID: <?php echo $id_projet; ?></h2>
                <hr>
                <h3>Installation Procedure :</h3>
                <p><?php echo $proc_ins_local; ?></p>
                <hr>
                <h3>Installation Procedure:</h3>
                <p><?php echo $proc_ins_production; ?></p>
                <hr>
                <h3>Code Source:</h3>
                <p><a href="<?php echo $code_source; ?>"><?php echo $code_source; ?></a></p>
            </div>
        </div>
    </div>
    ...
    <script src="js/main.js"></script>
        ...
        // No documentation found for the specified project ID
        echo "No documentation found for the specified project ID.";
    }
} else {
    // Project ID is not provided in the URL
    echo "Project ID is not provided in the URL.";
}
?>
