...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["id_projet"])) {
    ...
    $delete_documentation_query = "DELETE FROM Documentation WHERE ID_Projet='$id_projet'";
    $delete_documentation_result = mysqli_query($conn, $delete_documentation_query);

    if (!$delete_documentation_result) {
        echo "Erreur lors de la suppression des documents associés au projet : " . mysqli_error($conn);
        exit;
    }

    $delete_project_query = "DELETE FROM Projets WHERE ID_Projet='$id_projet'";
